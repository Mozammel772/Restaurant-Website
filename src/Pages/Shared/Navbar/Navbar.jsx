...
const Navbar = () => {
  ...
  return (
    <div
      className={`h-20 w-full text-black Text/80 fixed top-0 left-0 z-50 duration-300 bg-orange-500 ${
    ...
    >
      ...
      >
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4 bg-black/90">
          <DialogPanel className="w-[94%] space-y-4 bg-red-400 p-6 border border-lightText rounded-md absolute top-10 m-5 bg-black">
